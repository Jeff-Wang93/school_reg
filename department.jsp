                ...
                <table border="1">
                    ...
                    <tr>
                        <form action="department.jsp" method="get">
                            ...
                            <th><input value="" name="DEPARTMENT ID"  size="10"></th>
                            <th><input value="" name="DEPARTMENT TITLE" size="10"></th>
            ...
            %>
                    ...
                    <tr>
                        <form action="department.jsp" method="get">
                            ...
                            <td>
                                <input value="<%= rs.getString("department_title") %>" 
                                    name="DEPARTMENT TITLE" size="10">
                            </td>
